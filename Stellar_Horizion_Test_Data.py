...
print(f"Source Public:{Source_pair.public_key}\n")
print(f"Destination Secret:{Destination_pair.secret}\n")
print(f"Destination Public:{Destination_pair.public_key}\n")
...
for balance in Source_account['balances']:
    ...
    if balance['asset_type']=="native":
        print(f"Asset Type:XLM,Total Balance:{balance['balance']}")
    else:
